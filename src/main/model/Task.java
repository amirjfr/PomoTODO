...
//    }
    ...
    public void setEstimatedTimeToComplete(int hours) {
        if (hours < 0) {
            throw new NegativeInputException("hours cannot be negative");
        }
        this.etcHours = hours;
    }
    ...
    // EFFECTS: replaces space with underscore for the status of the task
    public String statusInsertUnderscore() {
